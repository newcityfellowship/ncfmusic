...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.insert_date'
        db.add_column('content_song', 'insert_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 12, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.insert_date'
        db.delete_column('content_song', 'insert_date')
