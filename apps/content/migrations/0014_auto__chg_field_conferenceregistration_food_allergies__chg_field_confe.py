...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConferenceRegistration.food_allergies'
        db.alter_column('content_conferenceregistration', 'food_allergies', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'ConferenceRegistration.ride_from_airport'
        db.alter_column('content_conferenceregistration', 'ride_from_airport', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'ConferenceRegistration.food_allergies'
        db.alter_column('content_conferenceregistration', 'food_allergies', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ConferenceRegistration.ride_from_airport'
        db.alter_column('content_conferenceregistration', 'ride_from_airport', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'content.conferenceregistration': {
            ...
            'food_allergies': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            ...
            'ride_from_airport': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
