...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'Learn'
        db.create_table('content_learn_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('learn', models.ForeignKey(orm['content.learn'], null=False)),
            ('tag', models.ForeignKey(orm['content.tag'], null=False))
        ))
        db.create_unique('content_learn_tags', ['learn_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field tags on 'Learn'
        db.delete_table('content_learn_tags')
