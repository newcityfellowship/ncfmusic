...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConferenceRegistrant.student'
        db.add_column('content_conferenceregistrant', 'student',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConferenceRegistrant.student'
        db.delete_column('content_conferenceregistrant', 'student')
