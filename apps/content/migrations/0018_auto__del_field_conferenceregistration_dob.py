...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConferenceRegistration.dob'
        db.delete_column('content_conferenceregistration', 'dob')


    def backwards(self, orm):
        # Adding field 'ConferenceRegistration.dob'
        db.add_column('content_conferenceregistration', 'dob',
