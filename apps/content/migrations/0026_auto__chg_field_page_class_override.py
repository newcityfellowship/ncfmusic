...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.class_override'
        db.alter_column('content_page', 'class_override', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Page.class_override'
        db.alter_column('content_page', 'class_override', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'content.page': {
            ...
            'class_override': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
