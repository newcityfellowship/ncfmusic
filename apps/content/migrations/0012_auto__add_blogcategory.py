...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_blogcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
        ))
        db.send_create_signal('content', ['BlogCategory'])

        # Adding M2M table for field categories on 'BlogEntry'
        db.create_table('content_blogentry_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blogentry', models.ForeignKey(orm['content.blogentry'], null=False)),
            ('blogcategory', models.ForeignKey(orm['content.blogcategory'], null=False))
        ))
        db.create_unique('content_blogentry_categories', ['blogentry_id', 'blogcategory_id'])


    def backwards(self, orm):
        # Deleting model 'BlogCategory'
        db.delete_table('content_blogcategory')

        # Removing M2M table for field categories on 'BlogEntry'
        db.delete_table('content_blogentry_categories')
