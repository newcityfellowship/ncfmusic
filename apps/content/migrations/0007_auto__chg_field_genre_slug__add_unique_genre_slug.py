...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genre.slug'
        db.alter_column('content_genre', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=255))
        # Adding unique constraint on 'Genre', fields ['slug']
        db.create_unique('content_genre', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Genre', fields ['slug']
        db.delete_unique('content_genre', ['slug'])


        # Changing field 'Genre.slug'
        db.alter_column('content_genre', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))
