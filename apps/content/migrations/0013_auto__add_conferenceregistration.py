...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_conferenceregistration', (
            ...
            ('church_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('how_serving', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('skills', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('wanting_to_learn', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('housing', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('special_housing_needs', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('food_allergies', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ride_from_airport', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flight_information', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal('content', ['ConferenceRegistration'])


    def backwards(self, orm):
        # Deleting model 'ConferenceRegistration'
        db.delete_table('content_conferenceregistration')
    ...
    models = {
        ...
        'content.conferenceregistration': {
            ...
            'food_allergies': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'ride_from_airport': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
