...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.effective_date'
        db.add_column('content_song', 'effective_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 21, 0, 0)),
                      keep_default=False)

        # Adding field 'Genre.slug'
        db.add_column('content_genre', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.effective_date'
        db.delete_column('content_song', 'effective_date')

        # Deleting field 'Genre.slug'
        db.delete_column('content_genre', 'slug')
